...
const createSocket = (topic_id) => {
  ...
  channel.on(`comments:${topic_id}:new`, (resp) => renderComment(resp.comment));
...
function renderComments(comments) {
  ...
  document.querySelector('.collection').innerHTML = rendered_comments.join('');
}

function renderComment(comment) {
  const render_comment = commentTemplate(comment);
